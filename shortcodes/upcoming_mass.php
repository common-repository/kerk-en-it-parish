	...
	function kei_upcoming_masses_handler( $atts, $content = null ) {
		...
		foreach($churches as $church)
		{
			...
			if(count($masses) > 0) :
				...
				{
					if($dayOfWeek !== NULL && $dayOfWeek !== $mass->dayOfWeek) :
						break;
					endif;
